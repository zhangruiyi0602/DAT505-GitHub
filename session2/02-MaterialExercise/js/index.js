...
var material1 = new THREE.MeshNormalMaterial({shininess: 3});
var texture = new THREE.TextureLoader().load("Texture/texture.jpg");
var material4= new THREE.MeshBasicMaterial({map:texture});
var texture1 = new THREE.TextureLoader().load("Texture/texture1.jpg");
...
var mesh9 = new THREE.Mesh( geometry, material3 );
